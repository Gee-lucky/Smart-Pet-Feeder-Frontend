class AppUrl {
  ...
  static const String localBaseURL ="http:// 192.168.1.131:8000/api/v1"; // Replace with your server’s IP
  ...
  static const String feedNow = "$baseURL/auth/feed-now/";
  static const String scheduleFeeding = "$baseURL/auth/schedule-feeding/";
}
